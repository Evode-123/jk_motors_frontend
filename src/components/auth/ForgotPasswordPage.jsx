  ...
  return (
    ...
    >
      ...
      >
        ...
        <Link
          to="/login"
          className="inline-flex items-center gap-1.5 mb-5 text-xs font-medium no-underline transition-colors"
        ...
        <div className="flex flex-col items-center text-center mb-6">
          ...
          <h2 className="text-lg font-bold" style={{ color: '#f1f5f9' }}>Forgot password?</h2>
          <p className="text-sm mt-1" style={{ color: 'rgba(148,163,184,0.65)' }}>Enter your email to receive a reset link</p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="auth-input w-full pl-10 pr-4 py-3 rounded-xl text-sm transition-all"
