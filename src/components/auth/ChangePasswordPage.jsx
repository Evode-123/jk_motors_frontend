    ...
    >
      ...
      >
        ...
        <div className="flex flex-col items-center text-center mb-6">
          ...
          <h2 className="text-lg font-bold" style={{ color: '#f1f5f9' }}>Change your password</h2>
          <p className="text-sm mt-1" style={{ color: 'rgba(148,163,184,0.65)' }}>Set a new password before continuing</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <p className="text-xs mt-1" style={{ color: 'rgba(148,163,184,0.45)' }}>
              Min {PASSWORD_MIN_LENGTH} chars · uppercase · lowercase · number · special char
            </p>
          </div>
